...
from real_world_imitation.utils.pytorch_utils import pad_seq, stack_with_separator
...
def dynamic_plotting(name, plot, ylim, plot_length=0):
    """
        Dynamically plot graphs with the given name, plot and ylims(can be None).
        For multiple plots, pass a list of name, plot and ylim. 
        plot_length determins the xlim 
    """
    ...
    for n, p, y in zip(name, plot, ylim):
