...
from real_world_imitation.modules.layers import BaseProcessingNet, ConvBlockEnc, \
    ConvBlockDec, init_weights_xavier, get_num_conv_layers, ConvBlockFirstDec, ConvBlock, LayerBuilderParams
from real_world_imitation.modules.recurrent_modules import BaseProcessingLSTM, \
    BidirectionalLSTM
from real_world_imitation.modules.variational_inference import Gaussian
from real_world_imitation.modules.variational_inference import SequentialGaussian_SharedPQ
from real_world_imitation.modules.variational_inference import UnitGaussian
from real_world_imitation.utils.general_utils import SkipInputSequential, GetIntermediatesSequential, \
    remove_spatial, batchwise_index, batch_apply, map_recursive, apply_linear, ParamDict
from real_world_imitation.utils.pytorch_utils import like, AttrDictPredictor, batchwise_assign, make_one_hot, mask_out
from real_world_imitation.utils.general_utils import broadcast_final, AttrDict
...
class Predictor(BaseProcessingNet):
    def __init__(self, hp, input_size, output_size, num_layers=None, detached=False, spatial=True,
                 final_activation=None, mid_size=None, initial_batchnorm=False):
        ...
        super().__init__(input_size, mid_size, output_size, num_layers=num_layers, builder=hp.builder,
                         detached=detached, final_activation=final_activation, initial_batchnorm=initial_batchnorm)
