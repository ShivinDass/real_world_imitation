...
from real_world_imitation.modules.layers import BaseProcessingNet, FCBlock
from real_world_imitation.modules.losses import L2Loss
from real_world_imitation.modules.variational_inference import stack
from real_world_imitation.utils.general_utils import AttrDict, batchwise_assign, map_dict, \
    concat_inputs, listdict2dictlist, subdict
from real_world_imitation.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from real_world_imitation.modules.subnetworks import Predictor    # to avoid cyclic import
