...
from real_world_imitation.utils.general_utils import ParamDict
from real_world_imitation.utils.pytorch_utils import Updater
...
class BaseModel(nn.Module):
    ...
    def log_gradients(self, step, phase):
        ...
        self._logger.log_scalar(grad_norms.abs().max(), 'gradients/max_norm', step, phase)
    ...
    def log_weights(self, step, phase):
        ...
        self._logger.log_scalar(weights.mean(), 'weights/mean_norm', step, phase)
        self._logger.log_scalar(weights.abs().max(), 'weights/max_norm', step, phase)
