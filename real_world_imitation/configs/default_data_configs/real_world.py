...
data_spec = AttrDict(
    ...
    n_actions=3,
    state_dim=2048*2+384+7+6+2, #4111=front_cam_emb(resnet18->512/resnet50->2048) + mount_cam_emb(resnet18->512/resnet50->2048) + ee_cartesian_pos_ob(3+4) + ee_cartesian_vel_ob(3+3) + gripper_pos[2]
